...
describe('VertexUnitTest suite', function() {
    ...
    it('Test EdgeArray Members', function(done) {
        ...
        assert.deepEqual(edgeArray[0].startVertexId, new g.GraphId(7, 9));
        assert.deepEqual(edgeArray[0].endVertexId, new g.GraphId(8, 3));
        ...
        assert.deepEqual(edgeArray[1].startVertexId, new g.GraphId(2, 3));
        assert.deepEqual(edgeArray[1].endVertexId, new g.GraphId(4, 8));
        ...
        assert.deepEqual(edgeArray[2].startVertexId, new g.GraphId(3, 2));
        assert.deepEqual(edgeArray[2].endVertexId, new g.GraphId(4, 4));
